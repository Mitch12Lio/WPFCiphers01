...
using static WPFCiphers01.ViewModels.AtbashCipherViewModel;

namespace WPFCiphers01.Utilities
{
    public static class Algorithms
    {
        public static readonly Dictionary<char, char>? AtbashDictionary = Algorithms.CreateAtbashDictionary();

        public static readonly Dictionary<char, String>? MorseDictionary = Algorithms.CreateMorseDictionary();

        public static readonly DataTable PolybiusDT = Algorithms.CreatePolybiusDataTable();
